      ...
      <div className="container">
        ...
        <div className="feedSection">
          <div className="feedinfo">
            <p className="info">
              For Being <mark>Amazing</mark>.Let's Become a part of a amazing
              community <mark>DevCanvas</mark>.You can even Tell your's{" "}
              <mark>Issue Related to Website for Improving the Site</mark>
            </p>
          </div>
