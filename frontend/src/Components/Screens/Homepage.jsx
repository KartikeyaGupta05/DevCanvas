...
import CodingPage from "../HomepageScreen/CodeingPage";
...
// import CImage from "../../assets/c-language.svg";
// import CppImage from "../../assets/cpp-language.svg";
// import JavaImage from "../../assets/java-language.svg";
    ...
    <>
      ...
      <div className="container">
        ...
        <CodingPage
          ...
          info={
            <>
              Compile and execute <mark>C programs</mark> directly in your
              browser using GCC. Ideal for system-level programming and
              fundamentals.
            </>
          }
          image={Pycod}
        ...
        <CodingPage
          ...
          info={
            <>
              Write and execute <mark>C++ code</mark> with modern compiler
              support. Practice STL, OOP, and competitive programming.
            </>
          }
          image={Pycod}
          uniId="uni"
        ...
        <CodingPage
          ...
          info={
            <>
              Compile and run <mark>Java programs</mark> with proper class
              execution. Suitable for DSA, OOP, and backend fundamentals.
            </>
          }
          image={Pycod}
        />
        ...
        <CodingPage
          ...
          info={
            <>
              ...
              <mark>Developed by Google</mark> and it is use with{" "}
              <mark>Flutter </mark>to Create Mobile and Web Application .Embrace
              your <mark>Knowledge</mark> with <mark>Dart Code Editor</mark>
            </>
          }
          image={CodJava}
          // poss={{'flexDirection':'row'}}
